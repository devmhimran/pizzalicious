      ...
      <div>
        ...
        {dashboardNavLink.map((data, index) => (
          <>
            ...
            <div
              key={index}
              onClick={() => router.push(data.navLink)}
              className={`flex items-center gap-3.5 mt-5 p-4 
            border border-1 rounded-xl my-2 hover:bg-[#fff3f3] 
            hover:border-brandColor01 ${styles.dashboard__nav}`}
            >
              <span
